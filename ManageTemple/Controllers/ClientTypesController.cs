...
namespace ManageTemple.Controllers
{
    public class ClientTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClientTypeID,Name,isDefault,isActive")] ClientType clientType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClientTypeID,Name,isDefault,isActive")] ClientType clientType)
        {
            if (ModelState.IsValid)
            {
