...
public static class ccProcessor
{
    ...
    /// </returns>
    public static ANetResponse chargeCard(OrderedData shoppingCart, devoteeInfo devoteeInfo, creditCardType creditCardType)
    {
        ...
        */
        ...
        var lineItems = new lineItemType[shoppingCart.orderItemCount];
        int i = 0;
        foreach (var cartItem in shoppingCart.CartList)
        {
        ...
        var transactionRequest = new transactionRequestType
        {
            ...
            amount = shoppingCart.orderTotal,
            payment = paymentType,
            lineItems = lineItems
        };
    ...
    public static ANetResponse chargeCard2(OrderedData OrderData, devoteeInfo devoteeInfo, creditCardType creditCardType)
    {
        Console.WriteLine("Charge Credit Card Sample");
