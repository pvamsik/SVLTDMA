<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/admin.master" Theme="Admin" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Login ID="siteLogin" runat="server"
        DestinationPageUrl="~/" PasswordRecoveryUrl="~/Account/forgotPassword.aspx"
