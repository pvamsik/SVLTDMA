...
public partial class Administration_index : System.Web.UI.Page
{
    ...
    {
        ANetApiResponse ANAR = new ANetApiResponse();
        ANAR = GetSettledBatchList.Run(ConfigurationManager.AppSettings["AuthorizeNetCNPLogin"], ConfigurationManager.AppSettings["AuthorizeNetCNPTransactionKey"]);
    }
